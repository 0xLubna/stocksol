...
export default function Home() {
  return (
    <main style={{ maxWidth: 640, margin: '2rem auto', padding: '0 1rem', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <p>
        StockPay sells just enough of your holding to pay a Solana Pay request, in one transaction when the route fits. This site
        shows the merchant side live.
      </p>
      <p>
        <Link href="/merchant" style={{ textDecoration: 'underline' }}>
          Get paid in USDC
        </Link>
        {' · '}
